...
class NamespaceInterpretationTest(SeleniumTestCase):
    ...
    def test_namespaces_after_lare(self):
        ...
        self.assert_current_namespace('lare.about')
        ...
        self.assert_current_namespace('lare.project.index')  # multiline namespace - prove for #24
